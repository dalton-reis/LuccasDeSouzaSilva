...
namespace ProjetoTCC
{
    ...
    {
        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_GetVersion", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_GetVersion();

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_GetNewConnectionId", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_GetNewConnectionId();

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_SetStreamLog", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_SetStreamLog(int connectionId, string filename);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_SetDataLog", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_SetDataLog(int connectionId, string filename);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_WriteStreamLog", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_WriteStreamLog(int connectionId, int insertTimestamp, string msg);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_WriteDataLog", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_WriteDataLog(int connectionId, int insertTimestamp, string msg);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_Connect", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_ReadPackets", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_ReadPackets(int connectionId, int numPackets);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_GetValueStatus", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_GetValue", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_SendByte", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_SendByte(int connectionId, int b);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_SetBaudrate", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_EnableAutoRead", CallingConvention = CallingConvention.Cdecl)]
        public static extern int TG_EnableAutoRead(int connectionId, int enable);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_Disconnect", CallingConvention = CallingConvention.Cdecl)]
        public static extern void TG_Disconnect(int connectionId);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "TG_FreeConnection", CallingConvention = CallingConvention.Cdecl)]
        public static extern void TG_FreeConnection(int connectionId);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "MWM15_getFilterType", CallingConvention = CallingConvention.Cdecl)]
        public static extern int MWM15_getFilterType(int connectionId);

        [DllImport(@"resources\dll\thinkgear.dll", EntryPoint = "MWM15_setFilterType", CallingConvention = CallingConvention.Cdecl)]
