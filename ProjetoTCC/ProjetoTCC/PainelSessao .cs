...
namespace ProjetoTCC
{
    class PainelSessao : PainelPadrao
    {
        ...
        private void createEdit()
        {
            ...
            btStartVideo.Location = new System.Drawing.Point(pbVideo.Location.X + pbVideo.Size.Width - btStartVideo.Size.Width - 5, pbVideo.Location.Y + pbVideo.Size.Height + 5);
            ...
            this.pnlEdit.Controls.Add(btPdfSessao);
            btPdfSessao.Size = new System.Drawing.Size(80, 30);
            btPdfSessao.Location = new System.Drawing.Point(pbVideo.Location.X + pbVideo.Size.Width - btPdfSessao.Size.Width - 5, btStartVideo.Location.Y + btStartVideo.Size.Height + 5);
        ...
        public void btGeraPdfSessao(object sender, EventArgs e)
        {
            ...
            Paragraph paragrafo = new Paragraph("Test", new iTextSharp.text.Font(iTextSharp.text.Font.NORMAL, 14));
        ...
        public void btIniciaVideoClick(object sender, EventArgs e)
        {
            if(cam == null)
            {
                ...
                int[] VIDEOCONFIG = new int[] { VIDEODEVICE, pnlEditControl.Size.Width, pnlEditControl.Size.Height, VIDEOBITSPERPIXEL };
